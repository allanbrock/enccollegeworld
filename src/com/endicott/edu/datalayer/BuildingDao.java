...
public class BuildingDao {
    ...
    private static void testNotes() {
      ...
      //my test
        ...
        DormModel m1 = new DormModel("Dormitory", 0, 20,"Medium");
        AdministrativeBldgModel m2 = new AdministrativeBldgModel("Admin", 20);
        ArrayList<BuildingModel> buildings = new ArrayList<>();
        buildings.add(m1);
        buildings.add(m2);
        dao.saveAllBuildings(collegeId, buildings);
        ...
        DiningHallModel m3 = new DiningHallModel( "Dining", 200, 100,"Medium" );
        AcademicCenterModel m4 = new AcademicCenterModel("Academic", 200, 100, "Medium");
        dao.saveNewBuilding(collegeId, m3);
        outMsgs = dao.getBuildings(collegeId);
        assert(outMsgs.size() == 3);
