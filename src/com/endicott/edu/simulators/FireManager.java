...
public class FireManager {
    ...
    public void startCatastrophicFire(String runId, int hoursAlive) {
        ...
        int fireCost = getFireCost(numDeaths, buildingToBurn, runId);
    ...
    public int getFireCost(int victims, BuildingModel buildingToBurn,String runId) {
        Random rand = new Random();
        int randCost = rand.nextInt(2000);
        if (victims > 1 && victims <= 10) {
            int costOfFire = victims * 10000;
            return costOfFire;
        } else if (victims > 10) {
